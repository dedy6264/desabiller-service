...
func IakPostpaidHelperService(providerRequest models.ReqPaymentPostpaidIak, url string) (respWorker models.ResponseWorkerPayment, err error) {

	var (
		helperName       = "[IAK]IakHelperServicePayment"
		respProvider     models.RespPaymentPostpaidIak
		statusCode       string
		statusMsg        string
